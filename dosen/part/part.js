  ...
  <div class="ix-navbar-menu">
    ...
    <ul class="dua">
      <li class="ix-role-status">
        <div class="btn btn-red btn-1x btn-round cursor-none" style="font-size:10px;line-height:23px;text-transform:uppercase;font-weight:bold">TEACHER</div>
      </li>
      ...
      <li class="ix-navbar-dropdown">
        ...
        <ul>
          <li class="ix-inter">
            <div>
              <b>Fulan Bin Fulan</b>
              <p>FIK / DKV <br> NIP. 910281389231</p>
            </div>
          </li>
